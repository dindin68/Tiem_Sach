...
@section('content')
    <div class="flex flex-col md:flex-row justify-between items-center bg-orange-50 border-l-4 border-green-700 rounded-lg shadow px-4 py-3 gap-4 md:gap-0">
    ...
    <form method="GET" class="mb-4 flex flex-wrap gap-4 items-end mt-4">
        <div>
            ...
            <select name="status" id="status" class="border-gray-300 rounded-md shadow-sm">
                ...
                <option value="Đang chuẩn bị" {{ request('status') == 'Đang chuẩn bị' ? 'selected' : '' }}>Đang chuẩn bị</option>
